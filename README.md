...
The goal was to study and experiment with white-box cryptography, focusing on the AES algorithm and the seminal paper: J.A. Muir, *A tutorial on white-box AES*, 2013.
